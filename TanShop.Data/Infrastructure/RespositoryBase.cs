...
namespace TanShop.Data.Infrastructure
{
    ...
    {
        #region Properties
        private TanShopDbContext dataContext;
        ...
        protected TanShopDbContext DbContext
        {
        ...
        public T SetSingleById(int id)
        {
            throw new NotImplementedException();
        }

        public T SetSingleByCondition(Expression<Func<T, bool>> expression, string[] includes = null)
        {
            throw new NotImplementedException();
        }
        #endregion
