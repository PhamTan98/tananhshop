namespace TanShop.Data.Migrations
{
    ...
    public partial class InitialDB : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.ProdcutTags", "TagID", "dbo.Tags");
            DropForeignKey("dbo.ProdcutTags", "ProductID", "dbo.Products");
            ...
            DropIndex("dbo.ProdcutTags", new[] { "TagID" });
            DropIndex("dbo.ProdcutTags", new[] { "ProductID" });
